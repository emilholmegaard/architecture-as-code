...
public class PackageDependencyTest {
    ...
    @ArchTest
    static final ArchRule controllers_should_only_be_in_presentation_rest = 
        classes().that().haveSimpleNameEndingWith("Controller")
            .should().resideInAPackage("..presentation.rest..")
            .because("Controllers should be in presentation.rest package");
    
    @ArchTest
    static final ArchRule entities_should_only_be_in_domain_model = 
        classes().that().haveSimpleNameEndingWith("Entity")
            .or().areAnnotatedWith(javax.persistence.Entity.class)
            .should().resideInAPackage("..domain.model..")
            .because("Entities should be in domain.model package");
    
    @ArchTest
    static final ArchRule repositories_should_only_be_in_infrastructure_persistence = 
        classes().that().haveSimpleNameEndingWith("Repository")
            .should().resideInAPackage("..infrastructure.persistence..")
            .because("Repositories should be in infrastructure.persistence package");
    
    @ArchTest
    static final ArchRule use_cases_should_only_be_in_application_usecase = 
    ...
    @ArchTest
    static final ArchRule dtos_should_only_be_in_presentation_dto = 
